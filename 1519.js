var topics = ["Ole Miss", "LSU", "University of Alabama", "Auburn", "University of Florida", "Vanderbilt"];
...
function renderButtons() {
    ...
    for (var i = 0; i < topics.length; i++) {
      $("#schoolButtons").append('<button class="btn btn-primary">' + topics[i] + '</button>');
    }      
